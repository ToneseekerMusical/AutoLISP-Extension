...
function getDefinitionLocations(roDoc: ReadonlyDocument, atom: ILispFragment): Array<vscode.Location> {
...
function processAsFunctionReference(context: IDocumentAtomContext): Array<vscode.Location> {
...
function processAsVariableReference(context: IDocumentAtomContext): Array<vscode.Location> {
...
function convertReferenceToLocation(iRef: ISymbolReference): vscode.Location {
	const filePointer = vscode.Uri.file(iRef.filePath);
	return new vscode.Location(filePointer, iRef.range);
}


function getAtomDocumentContext(roDoc: ReadonlyDocument, selected: ILispFragment, linearView?: Array<ILispFragment>): IDocumentAtomContext {
...
function getAllMatchingVerifiedGlobalReferences(lowerKey: string): Array<ISymbolReference> {
...
const GotoProviderSupport = {
	getDefinitionLocations,
	processAsFunctionReference,
	processAsVariableReference,
	convertReferenceToLocation,
	getAtomDocumentContext,
	getAllMatchingVerifiedGlobalReferences
}
